...
import clonegod.spring.framework.web.context.ContextLoader;
...
//				registerListeners();
				...
				SimpleController simpleController = (SimpleController) beanFactory.getBean(SimpleController.class.getSimpleName());
				if(simpleController!=null) {
					System.out.println(simpleController.sayHello("clonegod"));
				}
