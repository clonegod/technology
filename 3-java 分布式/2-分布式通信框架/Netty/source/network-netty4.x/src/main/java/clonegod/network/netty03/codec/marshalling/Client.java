package clonegod.network.netty03.codec.marshalling;

import java.io.File;
import java.io.FileInputStream;

import clonegod.uitls.file.GzipUtils;
...
public class Client {
	...
	public static void main(String[] args) throws Exception{
		...
		for(int i = 0; i < 5; i++ ){
			...
			String path = System.getProperty("user.dir") + File.separatorChar + "pom.xml";
